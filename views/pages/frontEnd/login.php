...
?>
<body>
  <script> document.title = "Login/Signup | <?php echo $websiteName; ?>"</script>
  <?php require '../../blades/menu.php';  ?>
  <main>
  <br>
  <br>
  <br>
    <section id="loginPage" class="card pageMargin">
      <div class="loginLogo">
      ...
      <?php } else{ ?>
        ...
        <div id="tabs">
            ...
            <div id="loginTab" class="tab-content current">
              ...
              <form id="userLogin" method="post" enctype="multipart/form-data"  action="../../../controllers/database/login.database.php" autocomplete="off">
                <div class="field">
            ...
            <div id="signTab" class="tab-content">
                ...
                <form id="userSignup" action="../../../controllers/database/signup.database.php" enctype="multipart/form-data" method="post" autocomplete="off">
                  <div class="columns 2">
                    <div class="nm column">
                      <div class="field">
                  ...
                  <div class="columns 2">
                    <div class="nm column">
                      <div class="field">
                        <input type="text" name="signupUsername" id="signupUsername" placeholder="Username" maxlength="15">
...
<div class="field">
                  ...
                  <div class="columns 2">
                    ...
                    <div class="nm column">
                      <div class="field">
                        <input type="password" name="signupPasswordConfirm" id="signupPasswordConfirm" placeholder="Confirm Password">
                        <label for="signupPasswordConfirm"><span class="required">*</span>Confirm Password</label>
                      </div>
                    </div>
                  </div>
                  ...
                  <label for="avatarFile"><span class="required">*</span>Upload Avatar: 10MB | jpg, jpeg, png, OR pdf</label>
                  ...
                  <div class="formCheckbox">
                    <label class="checkbox">
                      ...
                      <span class="text"><span class="required">*</span>I have read the <a href="tos">Terms of Services</a> and I accept the terms.</span>
                    </label>
                  </div>
