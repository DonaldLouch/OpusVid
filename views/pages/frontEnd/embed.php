<?php
  ...
  <body id="<?php echo $player["id"]; ?>">
    ...
    <?php if ($privacyCheck != "private" || $_SESSION['userName'] == $player['opusCreator'] || $userLevel == 'admin'  || $userLevel == 'mod') { ?>  
            <div class="theVideoWrap outer-container full embed" id="vidVidWrap">
              ...
              <h1 id="videoTitle" class="full"><?php echo $player["videoTitle"]; ?></h1>
