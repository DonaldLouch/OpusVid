<?php 
  ...
  $userClass = new Users;
  $profile = $userClass->getUser($userID);
?>

<body>
    <script>
    document.title = "Edit <?php echo $profile['userName']; ?> | <?php echo $websiteName; ?>"
    </script>
    ...
    <section id="editAccount" class="">
        ...
        <form id="adminEditAccount" method="post" action="../../controllers/database/editAccount.database.php"
            enctype="multipart/form-data" autocomplete="off">
            <div class="columns 2">
                <div class="nm column">
                    <input type="text" readonly name="numberID" value="<?php echo $profile['userID']; ?>">
                </div>
                <div class="nm column">
                    <input type="text" name="accountID" id="accounName" placeholder="Username"
                        value="<?php echo $profile['userName']; ?>" required>
                </div>
            </div>
            ...
            <div class="field">
                <textarea name="links" id="links" profiles="20" placeholder="Links"
                    required><?php echo $profile['userLinks']; ?></textarea>
                <label for="links"><span class="required">*</span>Links*</label>
            </div>
            <p style="margin: -1em 0 3em;">*Links should be formated as "LINKORUSERNAME;;TITLE || " in order for the
                links to properly be formated.</p>

            <hr>

            <label for="userlevel">User Level</label>
            <select name="userlevel" id="userlevel">
                <option value="<?php echo $profile['userLevel']; ?>"><?php echo $profile['userLevel']; ?></option>
                ...
                <option value="opusCreator">4 - OpusCreator</option>
            </select>

            <?php require '../../blades/recaptchaCodeHomepage.php'; ?>

            <button type="submit" name="editUserAdmin" class="submitButton">Edit Account</button>
        </form>
    </section>
