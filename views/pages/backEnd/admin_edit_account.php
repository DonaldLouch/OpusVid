...
?>
<body>
  <script> document.title = "Edit <?php echo $profile['userName']; ?> | <?php echo $websiteName; ?>"</script>
  ...
  <main>
    <section id="loginPage" class="">
      ...
      <form id="videoUpload" method="post" action="../../controllers/database/editAccount.database.php"  enctype="multipart/form-data" autocomplete="off">
        <div class="columns 2">
          <div class="nm column">
            <input type="text" readonly name="numberID" value="<?php echo $profile['userID']; ?>">
          </div>
          <div class="nm column">
            <input type="text" name="accountID" id="accounName" placeholder="Username" value="<?php echo $profile['userName']; ?>" required>
          </div>
        </div>
