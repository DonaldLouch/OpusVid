...
<body>
    ...
    <section id="manageVideo" class="">
        ...
        <form id="editVideo" method="post" action="../../controllers/database/videoEdit.database.php"
            ...
            <input type="text" hidden name="vidID" value="<?php echo $player['id']; ?>">
            <input type="text" hidden name="by" value="<?php echo $player['opusCreator']; ?>">
...
&#60;em&#62;TEXT&#60;/em&#62;
            ...
            <label for="thumbnailFile">Change Thumbnail (Only .jpg)</label>
