...
<body>
    <script>
    document.title = "Settings: TOS | <?php echo $websiteName; ?>"
    </script>
    ...
    <section id="loginPage" class="">
        ...
        <form id="settingsTOS" class="settingsForm" method="post"
            action="../../controllers/database/updateTerms.database.php">
