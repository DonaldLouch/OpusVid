...
<body id="sitemap">
    <script>
    document.title = "Sitemap | <?php echo $websiteName; ?>"
    </script>
    ...
    <div class="profileWrap card">
        <h3><span class="underline pageTitle">Sitemap</span></h3>
        <h3>Note that these are the current active pages with the current URL addresses and may change over time!</h3>
        <h4 style="margin: 1em 0; text-align:center;"><strong>BC</strong> = Being Consturcted (page may not be 100%
            functionable)</h4>
        ...
        <div id="pageTree">
            ...
            <section id="views">
                ...
                <ul>
                    ...
                    <li><a href="dashboard/manage_collections" class="button"><strong>*(2)*</strong> Manage Opus
                            Collections</a></li>
                    <li><a href="dashboard/new_collection" class="button"><strong>*(2)*</strong> New Opus
                            Collections</a></li>
                ...
                <ul>
                    ...
                    <li><a href="category?type=Animation" class="button"><strong>*(2)*</strong> Example: Category
                            Page</a></li>
                    <li><a href="collection?id=5bcbd78f96898" class="button"><strong>*(3)*</strong> Example: View Opus
                            Collections</a></li>
