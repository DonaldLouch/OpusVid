...
$sqlMail = "INSERT INTO mail (user_to, user_from, subject, message, status, importance, sent_time) VALUES ('MasterAdmin', 'Beta Tester', '$subject', '".mysqli_escape_string($mySQL, $message)."', 'unread', 'medium', '$currentTime')";
