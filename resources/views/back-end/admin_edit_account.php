...
if ($_SESSION['uLevel'] == 'admin') {
  if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) { ?>
      ...
      <body>
        <script> document.title = "Edit <?php echo $row['username']; ?> | OpusVid"; </script>
        <?php
          ...
          <form id="videoUpload" method="post" action="../../../database/db_a_account.php"  enctype="multipart/form-data" autocomplete="off">
            <div class="field">
              <input type="text" name="accountID" id="accountID" placeholder="Username" value="<?php echo $row['username']; ?>" required>
              <label for="accountID"><span class="required">*</span>Username</label>
            </div>

            <div class="columns 2">
              <div class="nm column">
                <div class="field">
                  <input type="text" name="signupFirstName" id="signupFirstName" placeholder="First Name" value="<?php echo $row['first_name']; ?>" required>
                  <label for="signupFirstName"><span class="required">*</span>First Name</label>
                </div>
              </div>
              <div class="nm column">
                <div class="field">
                  <input type="text" name="signupLastName" id="signupLastName" placeholder="Last Name" value="<?php echo $row['last_name']; ?>" required>
                  <label for="signupLastName"><span class="required">*</span>Last Name</label>
                </div>
              </div>
            </div>
            <div class="field">
              <input type="text" name="editEmail" id="editEmail" placeholder="Email" value="<?php echo $row['email']; ?>" required>
            ...
            <textarea name="description" placeholder="Description" rows="40"><?php echo $row['description']; ?></textarea>

            <input type="text" name="tags" placeholder="Tags" value="<?php echo $row['account_tags']; ?>">

            <label for="userlevel">User Level</label>
              <select name="userlevel" id="userlevel">
                <option value="<?php echo $row['userlevel']; ?>"><?php echo $row['userlevel']; ?></option>
                <option value="admin">0 - Admin</option>
                <option value="mod">1 - Moderator</option>
                <option value="staff">2 - Staff</option>
                <option value="user">3 - DEFULT User</option>
              </select>
