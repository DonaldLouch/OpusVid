        ...
        <body>
          ...
          ?>
              ...
              <form id="videoUpload" method="post" action="../../../database/db_editP.php"  enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="columns 2">
                  <div class="nm column">
                    <input type="text" name="signupFirstName" value="<?php echo $row['first_name']; ?>">
                  </div>
                  <div class="nm column">
                    <input type="text" name="signupLastName" value="<?php echo $row['last_name']; ?>">
                  </div>
                </div>
                ...
                <input type="text" name="tags" value="<?php echo $row['account_tags']; ?>">
