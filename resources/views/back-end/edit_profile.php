...
if (isset ($_SESSION['uID'])) {
  if ($result->num_rows > 0) {
        ...
        <body>
          ...
          ?>
              ...
              <form id="videoUpload" method="post" action="../../../database/db_editP.php"  enctype="multipart/form-data" autocomplete="off">
                ...
                <input type="text" hidden name="accountEmail" value="<?php echo $row['email']; ?>">
    ...
    <?php }
        ...
        echo "<h3>Sorry, this profile faild to load. Please try again or contact our support team at support@opusvid.com with the username:" . $accountID . " and we'll be happy to help you!</h3>";
        //echo $videoID;
  }
} else {
