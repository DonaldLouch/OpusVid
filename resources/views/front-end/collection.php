<?php
  ...
  if (!isset($_GET['index']) || $_GET['index'] < -1) {
    header("Location: collection?id=$collectionID&index=0");
  } elseif ($_GET['index'] > $videoNumber){
    $videoNumber = $videoNumber -1;
    header("Location: collection?id=$collectionID&index=$videoNumber");
  }
          ...
          <div class="collectionList">
            ...
            <?php for ($x = 0; $x < $videoNumber; $x++){
              ...
              <article id="<?php echo $collectionVid['id']; ?>">
                <a href="collection?id=<?php echo $collectionID; ?>&vid=<?php echo $collectionVid['id']; ?>&index=<?php echo $id; ?>" class="noLink">
  ...
  <? } else { ?>
    <body>
      <script> document.title = "COLLECTION ERROR | OpusVid"; </script>
      <?php include '../../page-templates/header.php'; ?>
      <div class="playerWrap">
