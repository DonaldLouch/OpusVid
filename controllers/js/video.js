...
const vidInfoWrap = document.querySelector(".vidInfoWrap");
const videoChapCom = document.querySelector("aside#videoChapCom");
const vidDescription = document.querySelector("#vidDescription");
...
function openFullscreen() {
	...
	theVideoWrap.className = "theVideoWrap outer-container full";
	...
	vidDescription.className = "vidPlayer hidden";
