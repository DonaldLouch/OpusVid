...
//Opus Vid Logo
		...
		opusLogoLink.className = "opusVidLogo"; //Adds the classname
		...
		opusLogoImage.data = vectorPath + "titleLogo.svg";
...
function toggleControls() {
  fullNavBar.className = "vidConON embed";
  vidTitle.className = "embed";
}
